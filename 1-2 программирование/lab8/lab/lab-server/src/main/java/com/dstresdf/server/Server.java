...
public class Server {
    public static void main(String[] args) throws SQLException {
        ...
        commandManager.add("info", new Info(studyGroupService));
        commandManager.add("show", new Show(studyGroupService));
        ...
        commandManager.add("average_of_students_count", new AverageOfStudentsCount(studyGroupService));
        commandManager.add("print_unique_students_count", new PrintUniqueStudentsCount(studyGroupService));
        commandManager.add("print_field_ascending_expelled_students", new PrintFieldAscendingExpelledStudents(studyGroupService));
...
// кто должен щаниматься обработкой ошибок CompletableFuture цепочки
// fix retry help +
